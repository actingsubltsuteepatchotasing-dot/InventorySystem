...
export const IMPORT_SETS = [
  ...
  },
  {
    ...
    name: "ประเภทลูกค้า",
    screen: "custkinds",
    hint: "เพิ่มทะเบียนประเภทลูกค้า · รหัสที่ซ้ำจะไม่ถูกเขียนทับ",
    key: "code",
    keyName: "รหัสประเภทลูกค้า",
    fields: [
      { id: "code", name: "รหัสประเภทลูกค้า", type: "text", need: true, example: "CT01",
        note: "ห้ามซ้ำ · ไม่เกิน 50 ตัวอักษร" },
      { id: "name", name: "ชื่อประเภทลูกค้า", type: "text", need: true, example: "ตัวแทนจำหน่าย",
        note: "ค่านี้คือค่าที่จะไปอยู่ในข้อมูลลูกค้า · ห้ามซ้ำ · ไม่เกิน 200 ตัวอักษร" },
      { id: "note", name: "หมายเหตุ", type: "text", need: false, example: "ได้ส่วนลดพิเศษ", note: "" },
    ],
  },
  {
    id: "leads",
    name: "ลูกค้าเป้าหมาย",
    screen: "leads",
    hint: "นำเข้ารายชื่อผู้สนใจเป็นชุด · รหัสที่ซ้ำจะไม่ถูกเขียนทับ",
    key: "code",
    keyName: "รหัสผู้สนใจ",
    fields: [
      { id: "code", name: "รหัสผู้สนใจ", type: "text", need: true, example: "L0001",
        note: "ห้ามซ้ำ" },
      { id: "name", name: "ชื่อผู้สนใจ / บริษัท", type: "text", need: true,
        example: "ร้านวัสดุก่อสร้างรุ่งเรือง", note: "" },
      { id: "contact", name: "ชื่อผู้ติดต่อ", type: "text", need: false, example: "คุณสมชาย", note: "" },
      { id: "phone", name: "เบอร์โทร", type: "text", need: false, example: "081-2345678",
        note: "ต้องมีเบอร์โทรหรืออีเมลอย่างน้อยหนึ่งอย่าง" },
      { id: "email", name: "อีเมล", type: "text", need: false, example: "shop@example.com", note: "" },
      { id: "province", name: "จังหวัด", type: "text", need: false, example: "ขอนแก่น", note: "" },
      { id: "source", name: "แหล่งที่มา", type: "text", need: false, example: "ออกบูธ / งานแสดงสินค้า",
        note: "ใช้วัดว่าช่องทางไหนได้ลูกค้าจริงมากที่สุด" },
      { id: "note", name: "หมายเหตุ", type: "text", need: false, example: "ขอใบเสนอราคาเดือนหน้า", note: "" },
    ],
  },
  {
    id: "terms",
