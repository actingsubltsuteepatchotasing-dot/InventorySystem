...
const toInvoice = (r) => ({
  ...
  note: r.note || "",
  shipStatus: r.ship_status || "PACKING",
...
const fromInvoice = (v) => ({
  ...
  total: v.total,
  note: v.note || "",
  ship_status: v.shipStatus || "PACKING",
...
export async function loadAll() {
  ...
  const [locations, placements, sales, saleItems, docGroups, customers, company, invoices, invoiceItems] =
    await Promise.all([
