...
export async function loadAll() {
  ...
  const [stockCounts, stockCountItems, shipEvents, sqlConnections, salespersons, targets, forms] =
    await Promise.all([
...
export const salesReady = (missing) => !missing.includes("salespersons");
...
export async function seedIfEmpty(current) {
  ...
  if (!salesReady(missing)) fresh.salespersons = [];
