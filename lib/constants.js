 ...
 *
 * ไล่ไปข้างหน้าตามความเป็นจริงของงาน: จัดของ -> ส่งออกไป -> ถึงมือ
 * แต่ไม่ล็อกทิศทางไว้ เพราะของตีกลับหรือกดผิดก็ต้องย้อนได้
 */
export const SHIP_STATUS = [
  { id: "PACKING",   name: "กำลังจัดสินค้า", kind: "warn" },
  { id: "SHIPPED",   name: "ส่งสินค้าแล้ว",  kind: "info" },
  { id: "DELIVERED", name: "ถึงมือลูกค้า",   kind: "ok"   },
];
