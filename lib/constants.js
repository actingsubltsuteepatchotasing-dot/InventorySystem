...
/** บัญชีผู้ใช้แบบ Fixed ตามข้อกำหนด (ไม่ใช้ Database) */
export const AUTH = { username: "admin", password: "admin888" };

export const STORE_KEY = "raot-inv-v1";
export const SESSION_KEY = "raot-inv-session";
