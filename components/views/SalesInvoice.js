...
export default function SalesInvoice() {
  ...
  async function saveDoc() {
    ...
    const invoice = {
      ...
      // ประเภทลูกค้าคัดลอกไว้ในตัวใบด้วย ตามที่ตั้งไว้ที่หน้ารายละเอียดลูกค้า
      // ลูกค้าเลื่อนประเภททีหลัง (เช่น เป็นตัวแทนจำหน่าย) ใบเก่าต้องยังบอกได้ว่า
      // ณ วันที่ออกเอกสารนั้นเป็นประเภทอะไร ไม่งั้นรายงานย้อนหลังจะเปลี่ยนไปเอง
      custKind: cust.kind || "",
