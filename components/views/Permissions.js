...
//
// หน้านี้เป็นหน้าเดียวที่ไม่เช็คสิทธิของตัวเอง และตั้งใจให้เป็นแบบนั้น
//   ถ้าหน้านี้ปิดตัวเองได้ คนตั้งค่าจะล็อกตัวเองออกจากการแก้สิทธิถาวร
//   แก้กลับได้ทางเดียวคือไปแก้ในฐานข้อมูลตรง ๆ ซึ่งคนใช้ทั่วไปทำไม่ได้
//   (PERMS_SCREEN จึงถูกกันออกจากตารางสิทธิด้วย ดู lib/constants.js)
