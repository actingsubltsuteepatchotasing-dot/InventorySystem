...
export default function manifest() {
  return {
    name: "ระบบควบคุมสินค้าคงคลัง กยท.",
    // Android ตัดชื่อที่ยาวเกินราว 12 ตัวอักษรบนหน้าจอโฮม จึงต้องสั้นและยังรู้ว่าเป็นของใคร
    short_name: "คลัง กยท.",
    description:
      "ระบบควบคุมสินค้าคงคลัง การยางแห่งประเทศไทย — รับ เบิก โอน ปรับปรุงสินค้า ขายหน้าร้าน และรายงาน",
    id: "/",
    start_url: "/",
    scope: "/",
    display: "standalone",
